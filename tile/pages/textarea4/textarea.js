...
Page({
  ...
  onReviewTap: function (e) {
    ...
    setTimeout(function () {
      that.setData({
        ...
        reviewTextareaHidden: !that.data.reviewTextareaHidden,
        commentMaskRelease: false,
      })
    }, 500)
  },

  onReviewNewConfirm: function (e) {
    this.onTextareaConfirm();
  ...
  onReviewNewCancal: function (e) {
    let comments = this.data.comments
    let index = this.data.reviewedCommentIndex
  ...
  onTextareaLineChange: function (e) {
    ...
    // this.setData({
    //   cursorSpacing: this.data.cursorSpacing - height
    // })
  },
  ...
  onTextareaInput: function (e) {
    ...
    let index = this.data.reviewedCommentIndex
    let comment = comments[index]
    comment.reviewNew = e.detail.value
    this.setData({
      comments: comments
    })
  },
  ...
  onTextareaConfirm: function (e) {
    ...
    var reviews = comment.reviews || []
    var content = comment.reviewNew
